document.addEventListener("DOMContentLoaded", function () {
    ...
    const customInput = document.getElementById("nuevoRol");
    const addCustomBtn = document.getElementById("addCustomIntegrante");
    const lista = document.getElementById("listaIntegrantes");
    const inputGuardado = document.getElementById("integrantesGuardados");
    ...
    // Inicialmente agregar evento eliminar a los ya existentes
